...
export function SecondarySidebarItem({
	...
	const button = (
		...
		>
			...
			{isStub ? (
				<>
					<HammerIcon aria-hidden="true" className="text-muted-foreground/70" />
	...
	// The whole row is the tooltip's trigger, so the meaning shows on hover and on
	// keyboard focus alike. On the hammer alone it needed a pointer on a 16px
	// glyph, and a focused row said nothing.
	return (
		<li>
			{isStub ? (
				<Tooltip>
