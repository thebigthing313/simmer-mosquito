...
export function createNotificationTypesCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<NotificationType>({ table: 'notification_types', ...options }),
