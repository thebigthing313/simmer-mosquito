...
import { type Membership, membershipSchema } from './tables/memberships.js';
...
export const membershipsShapePath = shapePathFor('memberships');

export function createMembershipsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Membership>({ table: 'memberships', ...options }),
