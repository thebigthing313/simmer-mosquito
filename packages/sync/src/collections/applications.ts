...
import { type Application, applicationSchema } from './tables/applications.js';
...
export const applicationsShapePath = shapePathFor('applications');

export function createApplicationsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Application>({ table: 'applications', ...options }),
