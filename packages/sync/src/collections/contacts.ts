...
import { type Contact, contactSchema } from './tables/contacts.js';
...
export const contactsShapePath = shapePathFor('contacts');

export function createContactsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Contact>({ table: 'contacts', ...options }),
