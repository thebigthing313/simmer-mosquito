...
import { type Equipment, equipmentSchema } from './tables/equipment.js';
...
export const equipmentShapePath = shapePathFor('equipment');

export function createEquipmentCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Equipment>({ table: 'equipment', ...options }),
