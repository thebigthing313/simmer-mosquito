...
import { type MissionItem, missionItemSchema } from './tables/mission_items.js';
...
export const missionItemsShapePath = shapePathFor('mission_items');

export function createMissionItemsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<MissionItem>({ table: 'mission_items', ...options }),
			schema: missionItemSchema,
		}),
	);
}
