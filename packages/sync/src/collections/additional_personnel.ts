...
export function createAdditionalPersonnelCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<AdditionalPersonnel>({ table: 'additional_personnel', ...options }),
			schema: additionalPersonnelSchema,
		}),
	);
}
