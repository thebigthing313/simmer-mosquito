...
import { type Tag, tagSchema } from './tables/tags.js';
...
export const tagsShapePath = shapePathFor('tags');

export function createTagsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Tag>({ table: 'tags', ...options }),
			schema: tagSchema,
		}),
	);
}
