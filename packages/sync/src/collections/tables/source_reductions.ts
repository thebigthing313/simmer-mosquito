/**
 * The `source_reductions` table, as a client receives it.
 *
...
export const sourceReductionSchema = z.object({
	id: z.uuid(),
	organization_id: z.uuid(),
	source_reduction_method_id: z.uuid(),
	technician_profile_id: z.uuid().nullable(),
	source_reduction_date: z.string(),
	lat: z.number(),
	lng: z.number(),
	geom_type: z.string(),
	address_id: z.uuid().nullable(),
	habitat_id: z.uuid().nullable(),
	sources_eliminated_amount: z.number(),
	sources_eliminated_unit_id: z.uuid(),
...
export type SourceReduction = z.infer<typeof sourceReductionSchema>;
