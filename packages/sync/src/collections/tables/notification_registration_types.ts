/**
 * The `notification_registration_types` table, as a client receives it.
 *
...
export const notificationRegistrationTypeSchema = z.object({
	id: z.uuid(),
...
export type NotificationRegistrationType = z.infer<typeof notificationRegistrationTypeSchema>;
