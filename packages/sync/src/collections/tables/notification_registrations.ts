/**
 * The `notification_registrations` table, as a client receives it.
 *
...
export const notificationRegistrationSchema = z.object({
	id: z.uuid(),
	...
	buffer_distance: z.number().nullable(),
	buffer_unit_id: z.uuid().nullable(),
	has_bees: z.boolean(),
