/**
 * The `organization_species` table, as a client receives it.
 *
...
export const organizationSpeciesSchema = z.object({
	id: z.uuid(),
...
export type OrganizationSpecies = z.infer<typeof organizationSpeciesSchema>;
