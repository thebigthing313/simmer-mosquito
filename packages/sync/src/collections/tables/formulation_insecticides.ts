/**
 * The `formulation_insecticides` table, as a client receives it.
 *
...
export const formulationInsecticideSchema = z.object({
	id: z.uuid(),
	organization_id: z.uuid(),
	formulation_id: z.uuid(),
...
export type FormulationInsecticide = z.infer<typeof formulationInsecticideSchema>;
