/**
 * The `weather_source_subscriptions` table, as a client receives it.
 *
...
export const weatherSourceSubscriptionSchema = z.object({
	id: z.uuid(),
...
export type WeatherSourceSubscription = z.infer<typeof weatherSourceSubscriptionSchema>;
