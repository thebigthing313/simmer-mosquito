/**
 * The `service_requests` table, as a client receives it.
 *
...
export const serviceRequestSchema = z.object({
	...
	display_name: z.number().nullable(),
	intake_type: z.enum(['online', 'phone', 'walk-in', 'other']),
	...
	address_id: z.uuid(),
	contact_id: z.uuid(),
	received_by_profile_id: z.uuid().nullable(),
	details: z.string(),
	closed_at: z.coerce.date().nullable(),
	closed_by_profile_id: z.string().nullable(),
