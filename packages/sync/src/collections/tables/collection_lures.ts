/**
 * The `collection_lures` table, as a client receives it.
 *
...
export const collectionLureSchema = z.object({
	id: z.uuid(),
...
export type CollectionLure = z.infer<typeof collectionLureSchema>;
