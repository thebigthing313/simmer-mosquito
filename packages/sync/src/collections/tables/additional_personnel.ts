/**
 * The `additional_personnel` table, as a client receives it.
 *
...
export const additionalPersonnelSchema = z.object({
	id: z.uuid(),
	organization_id: z.uuid(),
	personnel_profile_id: z.uuid(),
...
export type AdditionalPersonnel = z.infer<typeof additionalPersonnelSchema>;
