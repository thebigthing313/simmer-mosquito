/**
 * The `source_reduction_methods` table, as a client receives it.
 *
...
export const sourceReductionMethodSchema = z.object({
	id: z.uuid(),
...
export type SourceReductionMethod = z.infer<typeof sourceReductionMethodSchema>;
