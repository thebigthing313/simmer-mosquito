/**
 * The `biocontrol_methods` table, as a client receives it.
 *
...
export const biocontrolMethodSchema = z.object({
	id: z.uuid(),
...
export type BiocontrolMethod = z.infer<typeof biocontrolMethodSchema>;
