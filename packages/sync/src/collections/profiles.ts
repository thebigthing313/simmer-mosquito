...
import { type Profile, profileSchema } from './tables/profiles.js';
...
export const profilesShapePath = shapePathFor('profiles');

export function createProfilesCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<Profile>({ table: 'profiles', ...options }),
