...
import { type CollectionSpecies, collectionSpeciesSchema } from './tables/collection_species.js';
...
export const collectionSpeciesShapePath = shapePathFor('collection_species');

export function createCollectionSpeciesCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<CollectionSpecies>({ table: 'collection_species', ...options }),
			schema: collectionSpeciesSchema,
		}),
	);
}
