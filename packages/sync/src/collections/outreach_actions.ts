...
import { type OutreachAction, outreachActionSchema } from './tables/outreach_actions.js';
...
export function createOutreachActionsCollection(options: SyncCollectionClientOptions) {
	...
	return createCollection(
		electricCollectionOptions({
			...syncCollectionConfig<OutreachAction>({ table: 'outreach_actions', ...options }),
			schema: outreachActionSchema,
		}),
	);
}
