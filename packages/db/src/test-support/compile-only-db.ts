 ...
 *
 * It proves the *shape* of the SQL a reader issues — that the organization
 ...
 * caller in the state a missing or cross-organization row produces, so the
 * handling of that state is testable without Postgres.
 *
