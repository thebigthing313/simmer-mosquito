...
import { Skeleton } from '@simmer/ui/components/skeleton';
import {
	Tooltip,
	TooltipContent,
	TooltipProvider,
...
import { useIsMobile } from '@simmer/ui/hooks/use-mobile';
...
function SidebarProvider({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: <shadcn implementation>
