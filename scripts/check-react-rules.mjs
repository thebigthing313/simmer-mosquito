...
const REACT_RULE_BACKLOG = new Map([
	...
	['apps/web/src/hooks/explorer/use-paged-map-resource.ts', 2],
	['apps/web/src/hooks/larval-surveillance/use-held-rows.ts', 3],
	['apps/web/src/hooks/map/use-map-extent-fit.ts', 1],
	['apps/web/src/hooks/map/use-map-padding.ts', 1],
	['apps/web/src/hooks/map/use-map-readout.ts', 1],
	['apps/web/src/hooks/search/use-accumulated-pages.ts', 3],
	['apps/web/src/hooks/search/use-deferred-open.ts', 2],
	['apps/web/src/hooks/search/use-editable-query.ts', 1],
	['apps/web/src/hooks/search/use-grow-on-visible.ts', 1],
