...
export function MainOutletHeader() {
	//TODO: Make these dynamic, probably on route context or something
	const title = 'Dashboard';
	const subtitle = 'Surveillance overview';
	return (
		<div className="flex items-center justify-between border-white/5 border-b px-6 py-5">
			<div>
				<h2 className="font-semibold text-lg text-white/90">{title}</h2>
				<p className="mt-0.5 text-white/30 text-xs">{subtitle}</p>
			</div>
