 ...
 * that talks to the command surface directly, a second client, import tooling,
 * a replayed offline queue, could complete an assignment that was never
 * started, or progress an item on a cancelled one.
 *
