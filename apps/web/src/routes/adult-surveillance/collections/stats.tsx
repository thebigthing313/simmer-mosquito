...
export const Route = createFileRoute('/adult-surveillance/collections/stats')({
	component: CollectionStatsRoute,
});

function CollectionStatsRoute() {
	return (
		<div className={pageContainer({ gap: 'overview', padding: 'page' })}>
			<header className="grid gap-1.5">
				...
				<p className="m-0 max-w-[68ch] text-muted-foreground text-sm">
					Species abundance and collection-effort trends over time.
				</p>
			</header>
			...
			<Empty className="min-h-[320px] border border-border/40 bg-muted/30">
				<EmptyHeader>
					...
					<EmptyDescription>
						Species composition and abundance charts for collections will live here.
					</EmptyDescription>
				</EmptyHeader>
			</Empty>
		</div>
