 ...
 * submit.
 *
 * Pass `map` for the forms that carry geography — the layout splits and hands
 * the right half to it. Omit it and the column stands alone.
 */
...
export function RecordFormPage({
	...
	/** The right-half map surface. Omit for forms with no geography. */
	...
	return <MapSplitPage map={map}>{column}</MapSplitPage>;
}
