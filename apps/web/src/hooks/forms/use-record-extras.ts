...
import { useAdditionalPersonnelMutations } from '../mutations/use-additional-personnel-mutations';
import { useCommentMutations } from '../mutations/use-comment-mutations';
import type { AdditionalPersonnelTarget } from '../queries/use-additional-personnel';
...
/**
 * What a create form attaches once the record itself has landed: the crew
 * rows, then the note the form's last box holds. Both run after the record
 * settles and both are best-effort.
 */
