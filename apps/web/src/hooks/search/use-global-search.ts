...
/**
 * The global search read the palette and the results page share, keyed on the
 * query string. The previous list stays as `placeholderData` while a new query
 * is in flight, and a request in flight finishes into the cache when the
 * palette closes.
 */
