...
/** One ordered stop on a route map, as framework-free geometry. */
 ...
 * numbered stop pins, with click and hover routed back out and the selected and
 * highlighted stops emphasised through feature-state. No-ops when `config` is
 * undefined.
 */
