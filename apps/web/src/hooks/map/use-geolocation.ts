...
/**
 * The browser Geolocation API as a status and a `locate()` call. Permission
 * prompting, success, denial, timeout and unsupported environments collapse
 * into one status plus an error message.
 *
 * @param onLocated invoked with fresh coordinates on each successful fix.
 */
