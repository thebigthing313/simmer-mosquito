...
/**
 * Binds a single GeoJSON overlay to a live Mapbox map, with an optional
 * click-to-select interaction whose highlight follows the selected feature
 * without the layers being re-added.
 */
