 ...
 * How many there are is read off the register and written nowhere, because a
 * count here and one in `docs/dashboard-spec.md` had both drifted from the
 * register by the time anyone compared the three (#1097).
 *
