 ...
 * between.
 *
 * Fourteen pages had assembled the same arrangement by hand — a scroll
 * container at the app's measure, a back link, the fork between placeholder,
 * unavailable and record, a two-column split, and a danger zone whose
 * acknowledgement dialog has to be held above the card that raises it. Each
 * carried its own skeleton, and each edit route carried another.
 *
