...
import { type CommitBaseline, flushedKeysAfter, planCommit } from '../key-entry/commit-plan';
import { KeyEntryDialog, type VariantMode } from '../key-entry/key-entry-dialog';
import {
	SPECIES_SEX_VALUES,
