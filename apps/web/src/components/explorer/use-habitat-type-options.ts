...
/**
 * The organization's Habitat Types, as filter options and as an id→name lookup.
 *
 ...
 * season's inspections by a type the organization has since stopped using is
 * exactly what an operator asking that question means. The pickers on the
 * *forms* are the surfaces that should offer only what is current.
 *
