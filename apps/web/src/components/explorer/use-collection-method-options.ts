...
/**
 * The organization's Collection Methods, as filter options and as an id→name
 * lookup.
 *
 ...
 *
 * Retired methods stay in the list, for the reason they do in {@link
 * useHabitatTypeOptions}: an explorer looks backwards, and a season's
 * collections made with a method the organization has since dropped are exactly
 * what an operator filtering by it is asking for. The pickers on the forms are
 * the surfaces that should offer only what is current.
 *
