...
/**
 * `on-demand`: What each registration asked to hear about, so it grows with the
 * registrations.
 *
 * This app writes notification_registration_types, so the collection carries
 * the three mutation handlers and every write through it names the command it
 * means.
 *
