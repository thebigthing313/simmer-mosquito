 ...
 */
export const collection_methods: Collection<CollectionMethod, string | number> =
	createCollectionMethodsCollection({
 ...
 */
collection_methods.createIndex((row) => row.id, { indexType: BasicIndex });
