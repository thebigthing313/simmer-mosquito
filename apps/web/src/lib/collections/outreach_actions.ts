 ...
 */
export const outreach_actions: Collection<OutreachAction, string | number> =
	createOutreachActionsCollection({
 ...
 */
outreach_actions.createIndex((row) => row.id, { indexType: BasicIndex });
