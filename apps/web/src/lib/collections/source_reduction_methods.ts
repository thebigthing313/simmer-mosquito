 ...
 */
export const source_reduction_methods: Collection<SourceReductionMethod, string | number> =
	createSourceReductionMethodsCollection({
		...syncClientOptions,
		syncMode: 'eager',
		mutations: true,
 ...
 */
source_reduction_methods.createIndex((row) => row.id, { indexType: BasicIndex });
