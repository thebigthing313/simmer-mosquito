...
Changed: every date and count in the organization console now reads the same
...
Nothing else moves. Which day a record belongs to is still the organization's
